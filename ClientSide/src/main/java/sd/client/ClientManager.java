...
public class ClientManager {
    ...
    private static void showAdsByState(String state) {
        try {
            HttpURLConnection connection = (HttpURLConnection) new URL(SERVER_URL + "/manage/ads?state=" + state).openConnection();
    ...
    private static void getAdByAid() {
        try {
            ...
            HttpURLConnection connection = (HttpURLConnection) new URL(SERVER_URL + "/manage/ads?aid=" +aid).openConnection();
            connection.setRequestProperty("Content-Type", "application/json");
            connection.setRequestMethod("GET");
            connection.setDoOutput(false);
    ...
    private static boolean changeAdState(int aid) {
        try {
            ...
            HttpURLConnection connection = (HttpURLConnection) new URL(SERVER_URL + "/manage/changead?state=" + state + "&aid=" + Integer.toString(aid)).openConnection();
